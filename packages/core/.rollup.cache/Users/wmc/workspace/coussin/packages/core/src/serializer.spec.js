...
describe("Serializer", () => {
    it("should toJSON", () => {
        ...
        expect(serializer.toJSON(new Map([
            ["a", 1],
            ["b", 2],
        ]))).toEqual({
            _t_: "Map",
    ...
    it("should stringify", () => {
        ...
        expect(serializer.stringify(BigInt(122))).toMatchInlineSnapshot(`"{\\"_t_\\":\\"BigInt\\",\\"v\\":\\"122\\"}"`);
        expect(serializer.stringify(Symbol("xxxx"))).toMatchInlineSnapshot(`"{\\"_t_\\":\\"Symbol\\",\\"v\\":\\"Symbol(xxxx)\\"}"`);
        ...
        expect(serializer.stringify({ a: 1 })).toMatchInlineSnapshot(`"{\\"_t_\\":\\"Object\\",\\"a\\":1}"`);
        expect(serializer.stringify([{ a: 1 }])).toMatchInlineSnapshot(`"[{\\"_t_\\":\\"Object\\",\\"a\\":1}]"`);
        expect(serializer.stringify(new Test())).toMatchInlineSnapshot(`"{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2}"`);
        expect(serializer.stringify([new Test()])).toMatchInlineSnapshot(`"[{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2}]"`);
        expect(serializer.stringify([new Test(), new Test()])).toMatchInlineSnapshot(`"[{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2},{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2}]"`);
        expect(serializer.stringify({ t: new Test() })).toMatchInlineSnapshot(`"{\\"_t_\\":\\"Object\\",\\"t\\":{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2}}"`);
        expect(serializer.stringify(new A())).toMatchInlineSnapshot(`"{\\"_t_\\":\\"A\\",\\"t\\":{\\"_t_\\":\\"Test\\",\\"a\\":1,\\"b\\":2}}"`);
    });
    it("should toObject", () => {
        ...
        expect(serializer.toObject({ t: { _t_: "Test", a: 1, b: 2 }, _t_: "Object" })).toStrictEqual({
            t: new Test(),
        });
        expect(serializer.toObject({
            _t_: "A",
    ...
    it("should parse", () => {
        ...
        expect(serializer.parse(`{"_t_":"A","t":{"_t_":"Test","a":1,"b":2}}`)).toStrictEqual(new A());
    });
});
